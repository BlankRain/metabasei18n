...
export default class SetUserPassword extends Component {
    ...
    formSubmitted(e) {
        ...
        if (ReactDOM.findDOMNode(this.refs.password).value !== ReactDOM.findDOMNode(this.refs.password2).value) {
            formErrors.data.errors.password2 = "密码不匹配";
        }
            ...
            <div>
                <form className="Form-new bordered rounded shadowed" onSubmit={this.formSubmitted.bind(this)} noValidate>
                    <FormField fieldName="old_password" formError={formError}>
                        <FormLabel title="当前密码" fieldName="old_password" formError={formError}></FormLabel>
                    ...
                    <FormField fieldName="password" formError={formError}>
                        ...
                        <input ref="password" type="password" className="Form-input Form-offset full" name="password" placeholder="确保和上面说的一样安全" onChange={this.onChange.bind(this)} required />
                        <span className="Form-charm"></span>
                    </FormField>

                    <FormField fieldName="password2" formError={formError}>
                        <FormLabel title="确认新密码" fieldName="password2" formError={formError} ></FormLabel>
                        <input ref="password2" type="password" className="Form-input Form-offset full" name="password" placeholder="确保和上面的一致" required onChange={this.onChange.bind(this)} />
                        <span className="Form-charm"></span>
                    </FormField>
