...
export default class ExpandableString extends Component {
    ...
    render() {
        ...
        if (this.state.expanded) {
            return (<span>{this.props.str} <span className="block mt1 link" onClick={this.toggleExpansion}>查看少的</span></span>);
        } else if (truncated !== this.props.str) {
            return (<span>{truncated} <span className="block mt1 link" onClick={this.toggleExpansion}>查看多的</span></span>);
        } else {
